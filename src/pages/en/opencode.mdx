...
- **claude-opus-4-5-20251101**：Anthropic 的 Claude 4.5 Sonnet
- **claude-sonnet-4-5-20250929**：Anthropic 的 Claude 4 Opus
- **openai/gpt-5.2**：OpenAI 的 GPT-5.2
- **openai/gpt-5.1**：OpenAI 的 GPT-5.1
- **gemini-3-pro-preview**：Google 的 Gemini 3 Pro
- **gemini-3-flash-preview**：Google 的 Gemini 3 Flash
